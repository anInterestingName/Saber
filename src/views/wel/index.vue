            ...
            <basic-container>
              <el-collapse v-model="logActiveNames">
                ...
                <el-collapse-item title="4.10.0发布 新增TenantGuard租户守卫工具" name="46">
                  ...
                  <div>
                    4.[修复]旧版 CRUD 组件 行 hover
                    状态下固定列背景色丢失，统一序号列与操作栏视觉表现
                  </div>
                ...
                <el-collapse-item
                  title="4.6.0发布 升级适配 SpringCloud2025 SpringBoot3.5"
                  name="42"
                >
                ...
                <el-collapse-item
                  title="4.3.0发布 多租户支持线程模式指定租户ID与忽略租户"
                  name="39"
                >
                ...
                <el-collapse-item
                  title="4.2.0发布 底层架构升级，分类core模块与starter模块"
                  name="38"
                >
                ...
                <el-collapse-item
                  title="4.0.0发布 升级 SpringBoot3 SpringCloud2023 JDK17"
                  name="36"
                >
...
.el-divider--horizontal {
  margin: var(--saber-space-3) 0 !important;
}
