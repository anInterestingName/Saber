...
| [REQ-2026-008](requirements/REQ-2026-008-ghcr-image-publishing.md) | GitHub Actions 构建并发布私有 GHCR 镜像 | CI/CD、Docker、Nginx、GHCR | 0.3 | 开发中 | Saber 5.x / 容器化发布 | [需求文档 0.3（开发完成，待远端验收）](requirements/REQ-2026-008-ghcr-image-publishing.md) | 不涉及 | [详细设计 0.3（已实现，本地验证通过）](design/DESIGN-REQ-2026-008-ghcr-image-publishing.md)；[测试文档 0.3（4 通过/1 阻塞）](test/TEST-REQ-2026-008-ghcr-image-publishing.md) | Codex | 2026-09-04 |
